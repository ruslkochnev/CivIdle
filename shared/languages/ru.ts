export const RU = {
   ...
   AngkorWatDesc: "Все примыкающие здания получают +1 к Множителю Производства Работников. Производит 1000 Работников",
   ...
   HagiaSophiaDescV2: "+5 Счастья. Здания с 0% Производственной Мощностью освобождаются от -1 Счастья. <b>При загрузке игры обеспечьте достаточное количество Счастья во избежание остановки производства</b>",
   ...
   MatrioshkaBrainDesc: "Позволяет учитывать науку в стоимости империи (5 Науки = 1 Стоимость Империи). +5 Науки за каждого занятого и незанятого рабочего. Это чудо можно улучшить, за каждое улучшение +1 Науки за каждого занятого и незанятого рабочего",
   ...
   UpgradeWonderNotProducingDesc: "Это чудо улучшается - <b>его усиление не будет работать до окончания улучшения</b>",
   Uranium: "Уран",
   ...
   LargeHadronColliderDesc: "Все здания разблокированные в Информационной Эпохе получают +2 к Множителям Производства, Производительности Работников и Хранилища. Это чудо можно улучшить, за каждое улучшение здания, разблокированные в Информационной Эпохе получат +1 к Множителям Производства, Производительности Работников и Хранилища. Лаборатория клонирования и Фабрика клонирования получат половину эффекта",
